...
int main(int argc, char* argv[])
{
  ...
  // sizes of a key-value insertion
  {
    ...
    std::cout << "InternalNode0: "
              << InternalNode0::node_stage_t::estimate_insert_one(&key, 0) << " "
    ...
    std::cout << "InternalNode1: "
              << InternalNode1::node_stage_t::estimate_insert_one(&key, 0) << " "
              << item_iterator_t<node_type_t::INTERNAL>::estimate_insert_one(&key, 0) << " "
              << internal_sub_items_t::estimate_insert_one() << std::endl;
    std::cout << "InternalNode2: "
              << InternalNode2::node_stage_t::estimate_insert_one(&key, 0) << " "
              << internal_sub_items_t::estimate_insert_one() << std::endl;
    std::cout << "InternalNode3: "
              << InternalNode3::node_stage_t::estimate_insert_one(&key, 0) << std::endl;
    std::cout << "LeafNode0: "
              << LeafNode0::node_stage_t::estimate_insert_one(&key, value) << " "
              << item_iterator_t<node_type_t::LEAF>::estimate_insert_one(&key, value) << " "
              << leaf_sub_items_t::estimate_insert_one(value) << std::endl;
    std::cout << "LeafNode1: "
              << LeafNode1::node_stage_t::estimate_insert_one(&key, value) << " "
              << item_iterator_t<node_type_t::LEAF>::estimate_insert_one(&key, value) << " "
              << leaf_sub_items_t::estimate_insert_one(value) << std::endl;
    std::cout << "LeafNode2: "
              << LeafNode2::node_stage_t::estimate_insert_one(&key, value) << " "
              << leaf_sub_items_t::estimate_insert_one(value) << std::endl;
    std::cout << "LeafNode3: "
              << LeafNode3::node_stage_t::estimate_insert_one(&key, value) << std::endl;
    std::cout << std::endl;
  }

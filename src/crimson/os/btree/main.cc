...
int main(int argc, char* argv[])
{
  ...
  std::cout << "size slot_t<fixed_key_0_t>: " << sizeof(slot_t<fixed_key_0_t>) << std::endl;
  std::cout << "size slot_t<fixed_key_1_t>: " << sizeof(slot_t<fixed_key_1_t>) << std::endl;
  std::cout << "size node_fields_01_t<fixed_key_0_t>: " << sizeof(node_fields_01_t<fixed_key_0_t>) << std::endl;
  std::cout << "size node_fields_01_t<fixed_key_1_t>: " << sizeof(node_fields_01_t<fixed_key_1_t>) << std::endl;

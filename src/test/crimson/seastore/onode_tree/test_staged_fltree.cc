  ...
  run_async([this] {
    {
      ...
      auto value1 = test.create_value(320);
      logger().info("\n---------------------------------------------"
      ...
      auto value2 = test.create_value(456);
      logger().info("\n---------------------------------------------"
      ...
      auto value3 = test.create_value(832);
      logger().info("\n---------------------------------------------"
      ...
      auto value4 = test.create_value(576);
      logger().info("\n---------------------------------------------"
...

    {
      ...
      auto value = test.create_value(1992);
      logger().info("\n---------------------------------------------"
